...
function online_pharmacy_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'online_pharmacy_tp_color_option', array(
  	...
  	$wp_customize->add_setting( 'online_pharmacy_tp_secoundary_color_option', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'online_pharmacy_tp_secoundary_color_option', array(
	   'description' => __('It will change the complete theme secondary color in one click.', 'online-pharmacy'),
	    'section' => 'online_pharmacy_color_option',
	    'settings' => 'online_pharmacy_tp_secoundary_color_option',
  	)));
